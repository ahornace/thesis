...
\begin{itemize}
    ...
    It is distributed under GNU GPLv3 license \citep{gnu}.
    ...
    It is distributed under Apache license \citep{apache}.
...
The Suggester may consume significant amount of resources for some specific queries (mainly Phrase Queries).
...
the integral part of the search engine. Thus, if their resource requirements are too high then they should not prevent
...
\begin{itemize}
    ...
    \item \textbf{Time threshold} – specifies time threshold for suggestions in milliseconds.

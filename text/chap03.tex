...
If a suggestion is focused, then its background color is changed to \textit{blue} and the text of the field shows the result
value as if this suggestion were selected. It looks like in the Figure \ref{suggestion_focused}.
